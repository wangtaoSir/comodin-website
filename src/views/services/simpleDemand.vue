<template>
  <div class="simpleClass">
    <el-dialog :visible.sync="dialogFormVisible" class="font-sty" :before-close="handleClose" :modal="isDialogMode">
      ...
      <div slot="footer" class="dialog-footer" style="display: flex;">
            <el-button type="primary" style="height: 40px;" @click="submitAdd('ruleForm')" :loading="fullscreenLoading">CONTACT US NOW</el-button>
            <div class="ndaTitl_bat">
...
use our standard template below;" noselect>
                ...
                <div class="ndaTitl " >We are committed to protecting any personal informa...</div>
              </div>
              <div class="ndadowload_But noselect" @click="fun_dowloadNDAFile"><a>DOWLOAD NDA</a></div>
            </div>
         </div>
      </div>
    </el-dialog>
...
export default {
  ...
  components: {},
  created () {
    // console.info('测试￥root')
    // console.info(this.$root.getRootValue1)
  },
  methods: {
    fun_dowloadNDAFile() {
...
.simpleClass .el-dialog__header{
    padding: 0px !important;
}
.simpleClass .el-dialog__body{
    // padding: 30px 35px !important;
    // padding-bottom: 0px !important;
    padding: 26px 29px !important;
    padding-bottom: 26px !important;
}
.simpleClass .el-dialog__footer{
